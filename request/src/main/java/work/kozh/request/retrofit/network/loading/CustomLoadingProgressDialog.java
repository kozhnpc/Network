...
public class CustomLoadingProgressDialog extends Dialog {
    ...
    public CustomLoadingProgressDialog(Builder builder) {
        super(builder.context);
        mDialogView = builder.mDialogView;
        cancelTouchOutside = builder.cancelTouchOutside;
    }

    private CustomLoadingProgressDialog(Builder builder, int themeResId) {
...
//        animationDrawable.stop();
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            mDialogView = LayoutInflater.from(context).inflate(R.layout.dialog_retrofit_loading_progress, null);
        }

        /**
         * 设置主题
         * @param resStyle style id
         * @return CustomLoadingProgressDialog.Builder
         */
        ...
        public CustomLoadingProgressDialog build() {
            if (resStyle != -1) {
                return new CustomLoadingProgressDialog(this, resStyle);
            } else {
                return new CustomLoadingProgressDialog(this);
            }
        }
    }
}
