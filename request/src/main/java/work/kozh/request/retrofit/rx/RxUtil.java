...
public class RxUtil {
    ...
    /**
     * 线程调度使用，统一加入了默认的加载条，并且加入了内存优化rxlifecycle2，rxjava生命周期
     */
        ...
        return new ObservableTransformer<T, T>() {
            ...
            public ObservableSource<T> apply(Observable<T> observable) {
                return observable.subscribeOn(Schedulers.io())
                        ...
                        .compose(ProgressObserverUtils.<T>applyProgressBar(activity))
    ...
    public static <T> ObservableTransformer<T, T> rxSchedulerHelper(final RxFragment fragment) {    //compose简化线程
        return new ObservableTransformer<T, T>() {
            ...
            public ObservableSource<T> apply(Observable<T> observable) {
                return observable.subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .compose(ProgressObserverUtils.<T>applyProgressBar(fragment.getActivity()))
